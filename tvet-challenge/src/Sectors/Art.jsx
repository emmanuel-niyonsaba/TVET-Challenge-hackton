...
import blackman from '../assets/sector-photos/art/blackman.jpg'
import bord from '../assets/sector-photos/art/bord.jpg'
import bottles from '../assets/sector-photos/art/bottles.jpg'
import drow from '../assets/sector-photos/art/drow.jpg'
import landscape from '../assets/sector-photos/art/landscape.jpg'
import trees from '../assets/sector-photos/art/trees.jpg'
...
const Art = ({ agriculturalStats, slideshowImages }) => {
...
Rwandan art, known for its intricate basket weaving (agaseke), pottery, beadwork, and woodworking, vividly reflects the country's rich cultural heritage. 
Traditional paintings and contemporary art showcase Rwanda’s evolving creative scene. These artistic expressions preserve cultural identity and boost the local economy.          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl shadow-xl p-8">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6">
                  Rwanda's Craft and Art sector
                </h2>
                
                <p className="text-gray-600 leading-relaxed mb-8">
  The Craft and Art industry in Rwanda has undergone substantial expansion in recent years, evolving from a mere physical enhancement tool to a complex cultural phenomenon. Makeup has become an integral aspect of self-expression, confidence, and cultural. To provide a comprehensive examination of the evolving makeup landscape in Rwanda, elucidating the trends, challenges, and opportunities within the industry.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white transform hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="text-green-200 text-xs mt-1">Craft and Art workforce</div>
                  </div>
...
Urumuri and Gatagara Pottery, located in southern Rwanda, are celebrated centers of traditional ceramics. Gatagara, near Nyanza, is renowned for its high-quality, 
handcrafted pottery, reflecting Rwandan artistic traditions. Visitors can observe the intricate pottery-making process and purchase unique ceramic pieces. 
These centers offer a deep cultural experience and insight into Rwanda's artistic heritage.                </p>
              ...
              <div className="relative">
                <div className="relative overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src={landscape} 
                    alt="Agricultural landscape in Ngororero - Gatumba region" 
                ...
                <div className="mt-4 bg-emerald-50 p-4 rounded-lg border-l-4 border-emerald-400">
                  <p className="text-emerald-800 font-medium text-sm">
                    📍 Figure 11: Kigali-Rwanda
                  </p>
                  <p className="text-emerald-700 text-sm mt-1">
Visitors can explore the art, participate in workshops, and engage directly with the artists.                 </p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Sustainable Craft and Art</h3>
            <p className="text-gray-600 text-sm">Promoting eco-friendly Craft and Art practices</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <p className="text-gray-600 text-sm">Integrating technology in Craft and Art practices</p>
          </div>
        </div>
      </div>
    </div>
