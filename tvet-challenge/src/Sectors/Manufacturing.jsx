...
import craft from '../assets/sector-photos/manufacturing/craft.jpg'
import engeneers from '../assets/sector-photos/manufacturing/engeneers.jpg'
import inIndustry from '../assets/sector-photos/manufacturing/inIndustry.jpg'
import Photoportrait from '../assets/sector-photos/manufacturing/Photo-portrait.jpg'
import rwanda from '../assets/sector-photos/manufacturing/rwanda.jpg'
import TheJourney from '../assets/sector-photos/manufacturing/The-Journey.jpg'
...
const Manufacturing = ({ agriculturalStats, slideshowImages }) => {
...
Rwanda’s industry sector continues to grow. In 2023, the sector contributed 22 % to the country’s GDP.
Manufacturing grew by 10% during this period. The sector is characterized by gradual diversification from basic manufacturing to more value-adding activities in other sub-sectors that include:
...
The economy is heavily dependent on the growing sector as primarily and fully manufactured exports from Rwanda have found a big market in the EAC region due to their high quality and strategic positioning of the country.</p>   
     </div>
...
Although Rwanda’s liberalized economy has exposed locally manufactured products to stiff competition from imports, compliance with required international standards gives them an upper hand.</p>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white transform hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="text-green-200 text-xs mt-1">Manufacturing workforce</div>
                  </div>
...
A service export is any service (economic output of intangible commodities that may be produced, transferred, and consumed at the same time) provided by a resident in one country to people or companies from another.                        
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Sustainable Manufacturing</h3>
            <p className="text-gray-600 text-sm">Promoting eco-friendly Manufacturing practices</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <p className="text-gray-600 text-sm">Integrating Manufacturing</p>
          </div>
        </div>
      </div>
    </div>
