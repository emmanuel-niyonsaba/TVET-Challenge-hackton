...
import Enmental from '../assets/sector-photos/energy/Enmental.jpg'
import geothermal from '../assets/sector-photos/energy/geothermal.jpg'
import qualidade from '../assets/sector-photos/energy/qualidade.jpg'
import solarinsoil from '../assets/sector-photos/energy/solarinsoil.jpg'
import solarpannel from '../assets/sector-photos/energy/solarpannel.jpg'
import waterEnergy from '../assets/sector-photos/energy/waterEnergy.jpg'
...
const Energy = ({ agriculturalStats, slideshowImages }) => {
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white transform hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="text-green-200 text-xs mt-1">Energy workforce</div>
                  </div>
...
The Rwanda Energy Group (REG) was incorporated to expand, maintain and operate the energy infrastructure in the Country through its two subsidiaries the Energy Utility Corporation Limited (EUCL) and the Energy Development Corporation Limited (EDCL).            </p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Sustainable Energy</h3>
            <p className="text-gray-600 text-sm">Promoting eco-friendly Energy practices</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <p className="text-gray-600 text-sm">Integrating technology in Energy practices</p>
          </div>
        </div>
      </div>
    </div>
