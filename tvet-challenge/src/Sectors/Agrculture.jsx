...
import agri from '../assets/sector-photos/agriculture.jpg'

import caltivating from '../assets/sector-photos/arg/caltivating.jpg'
import crop from '../assets/sector-photos/arg/crop.jpg'
import largeland from '../assets/sector-photos/arg/large-land.jpg'
import largelandimg from '../assets/sector-photos/arg/large-land.jpg'
import tranctoronly from '../assets/sector-photos/arg/tractor-only.jpg'
...
const Agriculture = ({ agriculturalStats, slideshowImages }) => {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-green-700 max-w-2xl mx-auto">
            Exploring agricultural development and trends in the Ngororero - Gatumba region
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-8">
                  ...
                  <span className="font-bold text-green-600"> 64.5% </span>
                  of the total population. The industry contributes about 
                  <span className="font-bold text-green-600"> 25% </span>
                  to GDP, and it stands out as one of the most strategic sectors in Rwanda's 
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white transform hover:scale-105 transition-transform duration-300">
                    <div className="text-3xl font-bold mb-2">64.5%</div>
                    <div className="text-green-100 text-sm font-medium">Population Employment</div>
                    <div className="text-green-200 text-xs mt-1">Agricultural workforce</div>
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <h2 className="text-3xl font-bold text-gray-800 mb-4">
                  Ngororero - Gatumba Region
                </h2>
                <div className="w-20 h-1 bg-emerald-500 rounded mb-6"></div>
                
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Our comprehensive agricultural analysis showcases the diverse farming landscape 
                  of the Ngororero - Gatumba region. The data reflects current production trends, 
                  yield optimization, and land utilization across various agricultural sectors.
                </p>
              ...
              <div className="relative">
                ...
                <div className="mt-4 bg-emerald-50 p-4 rounded-lg border-l-4 border-emerald-400">
                  <p className="text-emerald-800 font-medium text-sm">
                    📍 Figure 11: Ngororero - Gatumba
                  </p>
                  <p className="text-emerald-700 text-sm mt-1">
                    Agricultural landscape showcasing farming practices and land utilization in the region
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <p className="text-gray-600 text-sm">Promoting eco-friendly agricultural practices</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <p className="text-gray-600 text-sm">Integrating technology in farming practices</p>
          </div>
        </div>
      </div>
    </div>
