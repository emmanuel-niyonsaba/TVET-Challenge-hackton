...
import focused from '../assets/sector-photos/beauty/focused.jpg'
import leashes from '../assets/sector-photos/beauty/leashes.jpg'
import makingup from '../assets/sector-photos/beauty/makingup.jpg'
import manywomens from '../assets/sector-photos/beauty/manywomens.jpg'
import mekauptolls from '../assets/sector-photos/beauty/mekauptolls.jpg'
import paintme from '../assets/sector-photos/beauty/paintme.jpg'
...
const Beauty = ({ agriculturalStats, slideshowImages }) => {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-green-700 max-w-2xl mx-auto">
            The Rwandan market is primarily comprised of imported beauty products, predominantly from Europe, the United States, and China.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl shadow-xl p-8">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6">
                  Rwanda's beauty and cosmetics sector
                </h2>
  ...
  The beauty and cosmetics industry in Rwanda has undergone substantial expansion in recent years, evolving from a mere physical enhancement tool to a complex cultural phenomenon. Makeup has become an integral aspect of self-expression, confidence, and cultural identity for numerous Rwandan women. To provide a comprehensive examination of the evolving makeup landscape in Rwanda, elucidating the trends, challenges, and opportunities within the industry.
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white transform hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="text-green-200 text-xs mt-1">Beauty and cosmetics workforce</div>
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Our comprehensiveRwanda has truly transformed my skincare routine. Their herbal products are a game-changer, and my skin has never looked and felt better.
                </p>
...
Since 2012, ‘‘Uburanga’‘ has 5,000 distributors across Rwanda. Today, the company’s value is estimated at $40,000.                  </p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Sustainable Beauty</h3>
            <p className="text-gray-600 text-sm">Promoting eco-friendly Beauty and cosmetics practices</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <p className="text-gray-600 text-sm">Integrating technology in Beauty and cosmetics practices</p>
          </div>
        </div>
      </div>
    </div>
