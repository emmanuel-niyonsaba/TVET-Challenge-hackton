...
import tra1 from '../assets/sector-photos/transport/tra1.jpg'
import tra2 from '../assets/sector-photos/transport/tra2.jpg'
import tra3 from '../assets/sector-photos/transport/tra3.jpg'
import tra4 from '../assets/sector-photos/transport/tra4.jpg'
import tra5 from '../assets/sector-photos/transport/tra5.jpg'
import tra6 from '../assets/sector-photos/transport/tra6.jpg'
...
const Transport = ({ agriculturalStats, slideshowImages }) => {

  const defaultData = {
    production: [
          { name: 'Cars', value: 600 },
      { name: 'Motocycles', value: 200 },
      { name: 'Bikecycles', value: 800 },
      { name: 'AirPlanes', value: 20 },
      { name: 'Trucks', value: 30 }
    ],
    yield: [
       { name: 'Cars', value: 2800 },
      { name: 'Motocycles', value: 2200 },
      { name: 'Bikecycles', value: 1800 },
      { name: 'AirPlanes', value: 20 },
...
Currently, Rwanda has no railway network. However, the country is working in partnership with other countries of the region to find a railway network. The railway network will contribute in lightening the country’s landlocked status, thus leading to a significant reduction of transport costs.
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white transform hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="text-green-200 text-xs mt-1">Transport Services workforce</div>
                  </div>
...
Rwanda is a land-locked and mostly mountainous country. Therefore, its transportation system has developed along the natural processes of creating and using land infrastructure - roads.                         </p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Sustainable Transport Services</h3>
            <p className="text-gray-600 text-sm">Promoting eco-friendly Transport Services practices</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <p className="text-gray-600 text-sm">Integrating transport Services</p>
          </div>
        </div>
      </div>
    </div>
