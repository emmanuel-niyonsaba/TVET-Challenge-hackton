...
import Architecture from '../assets/sector-photos/constru/Architecture.jpg'
import building from '../assets/sector-photos/constru/building.jpg'
import cups from '../assets/sector-photos/constru/cups.jpg'
import fpr from '../assets/sector-photos/constru/fpr.jpg'
import Intare_arena from '../assets/sector-photos/constru/Intare-arena.jpg'
import planning from '../assets/sector-photos/constru/planning.jpg'
...
Established in 2005, Real Contractors Ltd has been a cornerstone of Rwanda's construction industry. Our journey embodies dedication, innovation, and an unwavering commitment to excellence.          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl shadow-xl p-8">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6">
                  Rwanda's Construction and Building sector
                </h2>
                
                <p className="text-gray-600 leading-relaxed mb-8">
                      To build a better future for our customers and the community through innovative and sustainable solutions in the construction sector. </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white transform hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="text-green-200 text-xs mt-1">Construction and Building workforce</div>
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                   NPD COTRACO Ltd was the result of a merger between two entities, COTRACO s.a.r.l. and Nyarutarama Property Developers (NPD) s.a.r.l. Prior to the merger, COTRACO focused solely on the provision of prefabricated concrete products.NPD Ltd was established in 1996 as a Kigali based property developer specializing in the development of housing estates.                </p>
              ...
              <div className="relative">
                ...
                <div className="mt-4 bg-emerald-50 p-4 rounded-lg border-l-4 border-emerald-400">
                  ...
                  <p className="text-emerald-700 text-sm mt-1">
                      The combined expertise of these organizations has granted NPD Ltd. a profound understanding of civil engineering works and geographically specific needs               </p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Sustainable Construction and Building</h3>
            <p className="text-gray-600 text-sm">Promoting eco-friendly Construction and Building practices</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <p className="text-gray-600 text-sm">Integrating technology in Construction and Building practices</p>
          </div>
        </div>
      </div>
    </div>
